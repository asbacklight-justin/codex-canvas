...
const translations = {
  zh: {
    ...
    safetyTitle: '可逆 · 本地优先', safetyLine1: '不修改官方应用文件', safetyLine2: '不破坏应用签名',
    contact: '问题反馈与联系', unofficial: '非 OpenAI 官方产品 · v1.1.0',
    ...
    previewMode: '预览模式', themeRunning: '主题运行中', codexNotFound: '未找到 Codex', runtimeTheme: '运行时主题 · 不修改官方应用',
    ...
    safeNote: '不会修改 Codex/ChatGPT 官方应用文件或代码签名', cancel: '取消', closeApply: '关闭 Codex 并应用',
  ...
  en: {
    ...
    safetyTitle: 'Reversible · Local-first', safetyLine1: 'Never modifies official app files', safetyLine2: 'Preserves the app signature',
    contact: 'Support & feedback', unofficial: 'Independent product · Not affiliated with OpenAI · v1.1.0',
    ...
    previewMode: 'Preview', themeRunning: 'Theme active', codexNotFound: 'Codex not found', runtimeTheme: 'Runtime theme · official app untouched',
    ...
    safeNote: 'Official Codex/ChatGPT app files and signatures are never modified', cancel: 'Cancel', closeApply: 'Quit Codex and apply',
